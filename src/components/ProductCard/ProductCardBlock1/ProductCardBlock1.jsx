...
export const ProductCardBlock1 = () => {
  return (
    <div className='productCardBlock1'>
      ...
      <button className='productCardBlock1__desktopButton'>Дополнительная информация</button>
      <p className='productCardBlock1__text'>
        ...
        Sed quis mauris eget arcu facilisis consequat sed eu felis. Nunc sed porta augue. Morbi porta tempor odio,
