  ...
  return (
    <div className='contactsMain'>
      <div className='contactsMain__content'>
        ...
        <p className='contactsMain__content--font1'>Возникли вопросы? Хотите уточнить детали заказа? Свяжитесь с нами:</p>
        ...
        <nav className='contactsMain__content--nav'>
          <a href=""> <img src={require('../../../images/Contacts/viberIcon.png')} alt="" /> </a>
          <a href=""> <img src={require('../../../images/Contacts/facebookIcon.png')} alt="" /> </a>
          <a href=""> <img src={require('../../../images/Contacts/youtubeIcon.png')} alt="" /> </a>
          <a href=""> <img src={require('../../../images/Contacts/watsapIcon.png')} alt="" /> </a>
          <a href=""> <img src={require('../../../images/Contacts/telegramIcon.png')} alt="" /> </a>
        </nav>
      </div>
      <div className='contactsMain__form'>
        <p className='contactsMain__form--text addPadding'>Форма обратной связи:</p>
        <form action="">
